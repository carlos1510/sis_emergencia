(function () {
  ...
  if (!document.getElementById(codefundStylesheetId)) {
    ...
    stylesheet.setAttribute('href', 'https://codefund.io/packs/css/code_fund_ad-4bb42808.css')
  ...
  if (document.getElementById(codefundScriptId)) {
    ...
    script.setAttribute('src', 'https://codefund.io/packs/js/code_fund_ad-76c604a30617e8e72da2.js')

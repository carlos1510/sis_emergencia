...
<head>
    ...
    <!-- Meta tag Keywords -->
    <link rel="stylesheet" href="template_login/css/bootstrap.min.css">
    <!-- css files -->
    <link rel="stylesheet" href="template_login/css/style.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <link rel="stylesheet" href="template_login/css/fontawesome-all.css">
